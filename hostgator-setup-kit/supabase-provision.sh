...
PROJECT_NAME="${1:-KS_AtendimendoCRM}"
...
moldura "KS Atendimento IA · criando seu banco no Supabase"

if [ -z "${SUPABASE_ACCESS_TOKEN:-}" ]; then
  c_red "✖ Falta o token de acesso do Supabase."
  printf '\n' >&2
  c_dim "  1. Abra https://supabase.com/dashboard/account/tokens"
  c_dim "  2. Generate new token, dê um nome (ex.: ks_atendimentocrm) e copie"
