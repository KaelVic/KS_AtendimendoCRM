...
# 🛠️ KS Atendimento IA — o Sistema Operacional de Vendas com IA, open source, pro WhatsApp
...
*"instala o KS Atendimento IA pra mim"*. Ele lê o [`CLAUDE.md`](hostgator-setup-kit/CLAUDE.md) do kit
...
```bash
gh api repos/KaelVic/KS_AtendimendoCRM/branches/main/protection \
...
Abra uma [issue](https://github.com/KaelVic/KS_AtendimendoCRM/issues/new/choose) — o template pede o que precisamos (ambiente, `/api/v1/health`, steps). Rodar `bash hostgator-setup-kit/healthcheck.sh` e colar a saída ajuda muito.

Pra **vulnerabilidades de segurança**, **NÃO abra issue pública** — use o [relato privado de vulnerabilidades](https://github.com/KaelVic/KS_AtendimendoCRM/security/advisories/new). Detalhes em [`SECURITY.md`](SECURITY.md).
...
- **MCP público** — capabilities do CRM expostas pro ecossistema de agentes: plugue o agente que quiser e ele opera o KS Atendimento IA.
...
- **Discussões:** [GitHub Discussions](https://github.com/KaelVic/KS_AtendimendoCRM/discussions) — pra perguntas, ideias, showcase.
- **Issues:** [GitHub Issues](https://github.com/KaelVic/KS_AtendimendoCRM/issues) — bugs e tasks.
- **Instagram:** [@kaelsolutions](https://www.instagram.com/kaelsolutions)
- **YouTube:** [youtube.com/@kaelsolutions](https://www.youtube.com/@kaelsolutions)
...
- **Suporte é comunitário e "as-is".** Dúvidas e bugs entram como
  [Issues](https://github.com/KaelVic/KS_AtendimendoCRM/issues) ou
  [Discussions](https://github.com/KaelVic/KS_AtendimendoCRM/discussions). Não há SLA nem
...
Siga o desenvolvimento: [Instagram](https://www.instagram.com/kaelsolutions) · [YouTube](https://www.youtube.com/@kaelsolutions)
